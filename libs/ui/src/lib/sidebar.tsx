  ...
  return (
    <div className='w-full h-full'>
      <div className="object-none object-left pt-10 w-60 h-full pr-5 pl-5">
        <div>
          <button className="float-right h-10 px-3 text-red-100 transition-colors text-xl duration-150 bg-red-500 rounded-lg focus:shadow-outline hover:bg-red-800">
            <AiOutlineClose />
          </button>
        </div>
